...
namespace TrakME.Models
{
    ...
    public class EventReturnObject
    {
        ...
        public IList<TrakMeRouteReturnObject> Route { get; set; }

        public EventReturnObject()
        {
            this.Route = new List<TrakMeRouteReturnObject>();
        }
    }
    ...
    public class TrakMeRouteReturnObject
    {
        ...
        public bool IsActive { get; set; }
        public string days { get; set; }
        public int RouteLocationCount { get; set; }
    }
    ...
    public class MyEventListParam
    {
        public int UserId { get; set; }
        public bool IsMyEvent { get; set; }
    }
    public class SetIsTrakableParam
    {
        public int ParticipateId { get; set; }
        public bool IsTrackable { get; set; }
    }
